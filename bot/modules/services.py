...
async def start(_, message):
    ...
    buttons = ButtonMaker()
    buttons.url_button(
        lang.START_BUTTON1, "https://t.me/Bihari_Network"
    )
    buttons.url_button(lang.START_BUTTON2, "https://t.me/Bihari_Anime")
